...
public class NotificationScheduler {
    public static void showNotification(Context context, int level) {
        ...
        if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.S){
            resultPendingIntent = stackBuilder.getPendingIntent(DAILY_REMINDER_REQUEST_CODE, PendingIntent.FLAG_MUTABLE);
        }
        else{
            resultPendingIntent = stackBuilder.getPendingIntent(DAILY_REMINDER_REQUEST_CODE, PendingIntent.FLAG_UPDATE_CURRENT
